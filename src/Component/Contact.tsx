        ...
        <div className="grid lg:grid-cols-12 gap-8 bg-white rounded-3xl shadow-xl border overflow-hidden">
          ...
          <div className="lg:col-span-5 p-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
               disabled={loading}
              className="inline-flex items-center cursor-pointer gap-2 px-5 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
...
//   const [userInfo, setUserInfo] = useState<{ name: string, email: string, phone: string, subject: string, message: string }>({
//     name: "",
//     email: "",
//     phone: "",
//     subject: "",
...
//     try {
//       console.log("Sending data:", userInfo); // 👈 debug
...
// //   try {
// //     const response = await axios.post(`${API}/contact`, userInfo, {
// //       headers: { "Content-Type": "application/json" },
// //     });
...
//             <form onSubmit={handleSubmit} className="space-y-4">
//               <input onChange={handleChange} type="text" name="name" value={userInfo.name} className="w-full border rounded-md p-2" placeholder="Your Name" required />
//               <input onChange={handleChange} type="email" name="email" value={userInfo.email} className="w-full border rounded-md p-2" placeholder="Your Email" required />
//               <input onChange={handleChange} type="number" name="phone" value={userInfo.phone} className="w-full border rounded-md p-2" placeholder="Your Phone" />
//               {/* <input className="w-full border rounded-md p-2" placeholder="Subject" required /> */}
...
//                 ))}
//               </select>
//               <textarea rows={5} onChange={handleChange} name="message" value={userInfo.message} className="w-full border rounded-md p-2" placeholder="Your Message" required />

//               <button
//                type="submit"
//                  disabled={loading}

//                 className="inline-flex items-center  gap-2 px-5 cursor-pointer  py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
//                 {loading ? "Sending..." : "Send Message"} 
//                 <Send className="w-4 h-4 " />
